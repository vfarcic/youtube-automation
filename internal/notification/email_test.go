...
func TestGenerateThumbnailEmailContent(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectSubject: "Thumbnail: My Test Project",
		...
		},
		{
			...
			expectSubject: "Thumbnail: Project With URL",
		...
		},
		{
			...
			expectSubject: "Thumbnail: Project Other Logos",
		...
		},
		{
			...
			expectSubject: "Thumbnail: Project Both Logos",
		...
		},
		{
			...
			expectSubject: "Thumbnail: Project Tagline Ideas",
		...
		},
		{
			...
			expectSubject: "Thumbnail: Project N/A Logos",
		...
		},
		{
			...
			expectSubject: "Thumbnail: Project Empty Logos",
...
func TestGenerateEditEmailContent(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectErr:     false,
			expectSubject: "Video: My Edit Project",
			expectBodyContains: []string{
		...
		},
		{
			...
			expectErr:     false,
			expectSubject: "Video: Simple Project",
			expectBodyContains: []string{
